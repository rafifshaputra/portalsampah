...
<body>
    ...
    <div class="container" id="container-form">
        ...
        @endif
        <small id="emailHelp" class="form-text text-muted">*Form ini ditujukan untuk anda yang berminat untuk mendukung pengelolaan sampah plastik di Indonesia menjadi lebih baik</small>
