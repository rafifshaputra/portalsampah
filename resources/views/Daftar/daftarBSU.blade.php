...
<body>
    ...
    <div class="container" id="container-form">
        <form>
                <fieldset>
                  <legend><b>Daftar BSU</b></legend>
                  <div class="form-group row">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama BSU</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  name="namaBSU">
                  </div>
                  <div class="form-group">
                        <label for="exampleInputEmail1">Penanggung Jawab</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="penanggungJawab" aria-describedby="emailHelp">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Kontak BSU</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="kontak" aria-describedby="emailHelp">
                    </div>

                  <div class="form-group">
                    <label for="exampleTextarea">Alamat BSU</label>
                    <textarea class="form-control" id="exampleTextarea" name="alamatBSU" rows="3"></textarea>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Nomor SK</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="nomorSk" aria-describedby="emailHelp">
                    <small id="emailHelp" class="form-text text-muted">*Kami tidak akan menyebarkan data kepada siapapun</small>
                </div>

                  <div class="form-group">
                        <label for="exampleInputEmail1">Yang mengeluarkan SK</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="keluaranSk" aria-describedby="emailHelp">
                      </div>

                      <div class="form-group">
                        <label for="exampleInputEmail1">Tahun Berdiri</label>
                        <input type="number" class="form-control" id="exampleInputEmail1" name="tahunBerdiri" aria-describedby="emailHelp">
                      </div>
